const career: JobDetails[] = [
    {
      company: "Softtek",
      title: "Arquitecto de Software FrontEnd - Grupo Inditex",
    ...
    {
      company: "Softtek",
      title: "Analista Desarrollador Senior FrontEnd - Grupo Inditex",
      employmentType: "Jornada completa",
    ...
    {
      company: "Avansis",
      title: "Jefe de Proyecto & Desarrollador Full Stack",
      employmentType: "Jornada completa",
      duration: "dic. 2021 - oct. 2022",
      location: "Madrid, Comunidad de Madrid, España",
      remote: true,
      responsibilities: [
    ...
    {
      company: "Avansis",
      title: "Desarrollador Full Stack .NET + React",
      employmentType: "Jornada completa",
      duration: "jul. 2021 - dic. 2021",
      location: "Madrid, Comunidad de Madrid, España",
      remote: true,
      responsibilities: [
    ...
    {
      company: "Consultor tecnológico independiente",
      title: "Desarrollador Full Stack .NET + React - Grupo Dominion / The Phone House",
    ...
    {
      company: "Consultor tecnológico independiente",
      title: "Desarrollador Full Stack .NET + AngularJS - Universidad San Pablo CEU",
      employmentType: "Autónomo",
    ...
    {
      company: "Proyecto99.com",
      title: "Desarrollador Full Stack",
      employmentType: "Jornada completa",
      duration: "sept. 2017 - ago. 2018",
      location: "Madrid, Comunidad de Madrid, España",
      remote: true,
      responsibilities: [
    ...
    {
      company: "Grupo Assista",
      title: "Desarrollador Full Stack .NET + Angular",
      employmentType: "Jornada completa",
      duration: "dic. 2015 - sept. 2017",
      location: "Madrid, Comunidad de Madrid, España",
      remote: false,
      responsibilities: [
    ...
    {
      company: "Agencia MilViajes",
      title: "Jefe de Proyecto, líder técnico",
      employmentType: "Jornada completa",
      duration: "dic. 2009 - dic. 2014",
    ...
    {
      company: "Agencia MilViajes",
      title: "Desarrollador Full Stack ASP + JS",
      employmentType: "Jornada completa",
      duration: "feb. 2007 - dic. 2009",
      location: "Toledo, Castilla-La Mancha, España",
      remote: false,
      responsibilities: [
