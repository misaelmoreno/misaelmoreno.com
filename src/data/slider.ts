...
const slides: Record<Locale, { title: string; subtitle: string; imagePath: string }[]> = {
  es: [
    { title: 'Misael Moreno', subtitle: 'Arquitecto de software', imagePath: '/images/slider/1.webp' },
  ...
  en: [
    { title: 'Misael Moreno', subtitle: 'Software Architect', imagePath: '/images/slider/1.webp' },
