 ...
 * It includes the layout and logic for displaying sections, 
 * handling section visibility, and scrolling to specific sections 
 * when navigated through the Navbar or Menu components.
 */
...
/* 
 * PageContent is the main functional component that manages the 
...
/* 
 * Page is a wrapper component that renders the PageContent component.
 */
const Page: React.FC = () => {
  return <PageContent />;
}
